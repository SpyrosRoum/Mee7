...
from utils import create_pages, n_embed_warnings
...
class Moderation(commands.Cog):
    ...
    async def tempban(self, ctx, member: discord.User, duration, *, reason=None):
        ...
        # * Should I do something other than sleep?
    ...
    async def tempmute(self, ctx, member: discord.Member, duration: float):
        """tempmute [member] [duration in hours]"""
    ...
    async def warn(self, ctx, member: discord.Member, reason=None):
        ...
        await ctx.send(
            f"{member.mention} you have been warned {f'[{reason}] ' if reason else ''}and have {warnings} warnings")
    ...
    async def warnings(self, ctx, member: discord.Member = None):
        ...
        if member is not None:
            ...
            await create_pages(ctx, warnings, n_embed_warnings, "Warnings closed")
    ...
    async def announce(self, ctx, channel: discord.TextChannel, *, text):
        ...
        embed = discord.Embed(title="Announcement", description=text, color=ctx.author.color,
                              timestamp=ctx.message.created_at)
